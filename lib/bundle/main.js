...
var Util = function () {
  ...
  createClass(Util, null, [{
    key: 'getContentEditableInParent',
    value: function getContentEditableInParent(element) {
    ...
    key: 'isInputField',
    value: function isInputField(element) {
...
var CaretUtil = function (_Util) {
  inherits(CaretUtil, _Util);

  function CaretUtil() {
    classCallCheck(this, CaretUtil);

    var _this = possibleConstructorReturn(this, (CaretUtil.__proto__ || Object.getPrototypeOf(CaretUtil)).call(this));
  ...
  createClass(CaretUtil, [{
    ...
    value: function enable(target) {
      ...
      if (isNaN(range.Start) || isNaN(range.End) || range.Start < 0 || range.End < 0) {
    ...
    value: function getSelectedText() {
      ...
      var content = Util.getContent(this.target);
...
var Caret = function (_CaretUtil) {
  ...
  function Caret() {
    ...
    var _this2 = possibleConstructorReturn(this, (Caret.__proto__ || Object.getPrototypeOf(Caret)).call(this));
    ...
    window.onload = function () {
      ...
      var start = function start(target) {
        target.addEventListener('keyup', _this2._handleEvent.bind(_this2));
        target.addEventListener('mouseup', _this2._handleEvent.bind(_this2));
      };
